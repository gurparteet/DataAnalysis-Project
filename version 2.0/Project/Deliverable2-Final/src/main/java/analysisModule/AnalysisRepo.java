...
public class AnalysisRepo {
    ...
    private AnalysisRepo(){
        ...
        analysisRepo.put("PM2.5 % Change vs Forest Area % Change", new AirPollutionVsForestAreaAnnualChangeAnalysis());
        analysisRepo.put("Education Vs Health Expenditure % Change", new EducationVsHealthCareAnalysis());
        analysisRepo.put("CO2 Emissions Vs Energy Vs PM2.5 % Change", new CO2VsEnergyVsAirPollutionAnalysis());
    }
