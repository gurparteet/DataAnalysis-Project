...
public class MainUI extends JFrame{
	...
	private Vector<String> years, viewsNames, methodsNames, countryNames;
	private JComboBox fromList, toList, countriesList, viewsList, methodsList;
	private JPanel north ,south, east ,west;
	private JButton recalculate, addView, removeView;
	private JLabel viewsLabel, methodLabel, chooseCountryLabel, from, to;
